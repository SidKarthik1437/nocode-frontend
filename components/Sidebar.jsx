...
export default () => {
  ...
  const [iData] = useRecoilState(dataStore);
  ...
  const execute = (e) => {
    ...
    axios.post('http://172.16.3.45:8000/u/admin/test/first/', {
      nodes: nodes,
      edges: edges,
      data: iData
    },{
      headers: {
        ...
        'Authorization' : 'JWT eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjc2ODc2NDEwLCJqdGkiOiI5MjE5YjdkZTBiZDg0MzIxODAyOTQ2MGViMmYyMGVlMCIsInVzZXJfaWQiOjF9.DY6Ch-RbR7H8rS9xLUHVq4W22hgmi1oDeS3qJF0ah-c' ,
      }
    }).then(res => {
      console.log(res);
